...
class Poly {
  ...
  Poly(PVector trans, PVector spd, int ptCount, float rad, GeomStyle gs) {
    println("in this cstr: PVector trans, PVector spd, int ptCount, float rad, GeomStyle gs");
    this.trans = trans;
    this.spd = spd;
    ...
    //this.strokeCol = gs.strokeCol;
    //this.fillCol = gs.fillCol;
    //this.strokeWt = gs.strokeWt;
  }
    
  // super high maintainance
